...
const ProgramsCarousel: React.FC = () => {
  ...
  const programs = [
    {
      id: 1,
      title: 'Comprehensive NEET PG Coaching',
      description: 'Our flagship program, designed to provide in depth knowledge and skills for NEET PG Success',
    ...
    {
      id: 4,
      title: 'NEET PG Test Series',
      description: 'Comprehensive test series with detailed analysis and performance tracking for NEET PG preparation',
      image: '/images/programs/programs.jpg',
      category: 'NEET PG',
    },
  ];
